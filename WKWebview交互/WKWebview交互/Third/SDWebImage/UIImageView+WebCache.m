...
- (void)sd_setImageWithURL:(NSURL *)url {
    [self sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"no_pic"] options:0 progress:nil completed:nil];
}
...
- (void)sd_setImageWithURL:(NSURL *)url completed:(SDWebImageCompletionBlock)completedBlock {
    [self sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"no_pic"] options:0 progress:nil completed:completedBlock];
}
