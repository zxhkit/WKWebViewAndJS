...
-(void)setupUI {
    ...
    UIView *navView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenW, kNavBarH)];
    [self.view addSubview:navView];
    navView.backgroundColor = [UIColor whiteColor];
    
    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
    btn.frame = CGRectMake((kScreenW-200)/2.0, kStatusBarH + 5, 200, 35);
    [btn setTitle:@"点击调用JS的方法" forState:UIControlStateNormal];
